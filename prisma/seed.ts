  ...
  "weight-loss": [
    {
      ...
      description:
        "High-intensity interval training designed to maximize calorie burn and boost metabolism",
      category: "HIIT",
      exercises: [
        {
          name: "Burpees",
    ...
    },
    {
      ...
      description:
        "Dynamic cardio workout to torch calories and improve endurance",
      category: "Cardio",
      exercises: [
        {
          name: "High Knees",
    ...
    },
    {
      ...
      description:
        "Full-body metabolic workout to accelerate fat loss and build lean muscle",
      category: "HIIT",
      exercises: [
        {
          name: "Thrusters",
    ...
    },
    {
      ...
      description:
        "Circuit training focused on building lean muscle while burning fat",
      category: "Strength",
      exercises: [
        {
          name: "Squat to Press",
  ...
  "weight-gain": [
    {
      ...
      description:
        "Upper body focused workout designed to build muscle mass and strength",
      category: "Strength",
      exercises: [
        {
          name: "Bench Press",
    ...
    },
    {
      name: "Full Body Mass",
      description:
        "Complete full-body workout for maximum muscle growth stimulus",
      category: "Strength",
      exercises: [
    ...
    },
    {
      ...
      description:
        "Muscle hypertrophy workout with time under tension emphasis",
      category: "Strength",
      exercises: [
        {
  ...
  "muscle-building": [
    {
      name: "Push Day Power",
      description:
        "Push movement focused workout for chest, shoulders, and triceps",
      category: "Strength",
      exercises: [
        {
          name: "Bench Press",
    ...
    },
    {
      ...
      description:
        "Pull movement workout targeting back and biceps for muscle growth",
      category: "Strength",
      exercises: [
  ...
  "strength-training": [
    {
      ...
      description:
        "Foundation powerlifting workout focusing on the big three lifts",
      category: "Strength",
      exercises: [
    ...
    },
    {
      ...
      description:
        "Low rep, high weight training for peak strength development",
      category: "Strength",
      exercises: [
  ...
  mobility: [
    {
      ...
      description:
        "Gentle morning routine to improve flexibility and joint mobility",
...
async function main() {
  ...
  // Create system user for default workouts
  ...
  for (const [goalType, workouts] of Object.entries(defaultWorkouts)) {
    console.log(`  📂 Creating workouts for ${goalType}...`);

    for (const workoutTemplate of workouts) {
      // Create exercises first and get their connections
      const exercisePromises = workoutTemplate.exercises.map(
        async (exerciseData) => {
      ...
      totalWorkouts++;
      console.log(
        `    ✅ Created: ${workout.name} (${workout.exercises.length} exercises)`
      );
    }
  }

  console.log(`🎉 Successfully seeded ${totalWorkouts} default workouts!`);
